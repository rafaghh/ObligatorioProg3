...
namespace ObligatorioProg3.Controllers
{
    public class SociosController : Controller
    {
        ...
        {
            ViewData["LocalId"] = new SelectList(_context.Local, "Id", "Nombre");
            ViewData["TipoId"] = new SelectList(_context.TipoSocio, "Id", "TipoNombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TipoId,LocalId,Id,Nombre,Telefono,Email")] Socio socio)
        {
            ...
            ViewData["LocalId"] = new SelectList(_context.Local, "Id", "Nombre", socio.LocalId);
            ViewData["TipoId"] = new SelectList(_context.TipoSocio, "Id", "TipoNombre", socio.TipoId);
            return View(socio);
        }
